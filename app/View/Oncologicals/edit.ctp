...
<?php echo $this->Form->create('Oncological'); ?>
	<fieldset>
		<legend><?php echo __('Edit Oncological'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Oncological.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Oncological.id'))); ?></li>

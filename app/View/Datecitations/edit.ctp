...
<?php echo $this->Form->create('Datecitation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Datecitation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Datecitation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Datecitation.id'))); ?></li>

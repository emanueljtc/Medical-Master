...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Registrar Pacientes'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('Person', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('gender', array('label'=>'','type'=>'select','options'=>array(''=>'[SELECCIONE SEXO]','Femenino'=>'Femenino','Masculino'=>'Masculino'),'class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">

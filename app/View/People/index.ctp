...
<div class="row">
	...
	<tr>
		...
		<td class="text-center">
			...
			<?php echo $this->Form->postLink(__('<i class="glyphicon glyphicon-trash"></i>'), array('action' => 'delete', $person['Person']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Eliminar'), __('Desea usted eliminar al paciente # %s?', $person['Person']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
